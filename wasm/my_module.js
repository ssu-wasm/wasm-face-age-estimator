  ...
  return async function (moduleArg = {}) {
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      try {
        ...
        // 브라우저 환경에서는 fs를 사용할 수 없으므로 Node 환경이 아님
    ...
    if (!ENVIRONMENT_IS_NODE && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
      try {
    ...
    function findWasmBinary() {
      return locateFile("my_module.wasm");
    }
